...
class word_smartadmin_ui extends SmartadminInputs {
    ...
    private static function input_word_row($name, $id=0, $order=0){
        ...
        $html.= '<section class="col-xs-1 visible-sm visible-xs"><span class="">'.$order.'</span></section>';
        ...
        $html.= '<section class="'.$classContent.'">'.parent::text_addon($japan_params).'</section>';
        ...
        $html.= '<section class="'.$classContent.'">'.parent::text_addon($english_params).'</section>';
